...
- SQL injection: never interpolate user values into SQL — pass them as bound parameters (asyncpg: $1,$2 arguments; psycopg/sqlite3: %s / ? with a params tuple; SQLAlchemy: text() with :name binds). Keep behaviour identical, including LIKE wildcards (put the % into the parameter value, e.g. f"%{{q}}%").
